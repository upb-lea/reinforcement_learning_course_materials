...
%Ensure that overlay/pause does not increase counter when an overlay slide is incremented
\resetcounteronoverlays{mydefi}
\resetcounteronoverlays{mytheo}
\resetcounteronoverlays{myalgo}
