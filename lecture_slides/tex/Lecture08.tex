...
\frame{\frametitle{Supervised Learning Problem Statement}
	...
	\begin{itemize}
		...
		\item On top of $\bm w$, a ML model might also have hyperparameters that can be optimized (e.g. number of layers in a neural network).
	\end{itemize}
}
...
\begin{itemize}
	...
	\item Categorical: e.g. \{blue, green, red\}\pause
...
\begin{figure}
\includegraphics[width=10cm]{fig/lec08/dilbert.jpg}
\end{figure}
\vspace{1cm}
\centering
