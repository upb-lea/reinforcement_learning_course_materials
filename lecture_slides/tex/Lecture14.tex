...
\begin{itemize}
	...
	\item Sampling time of the plant system is $T_\text{s}=50\, \upmu \text{s}$
...
\center
Youtube link:
	\href{https://www.youtube.com/watch?v=hQ49Mc6LV78}{Coffee machine vs. deep Q direct torque control}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\frametitle{Usage in drive control: classical agent}
\begin{figure}
...
%% Meta RL for drives %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\frametitle{Usage in drive control: meta agent}
\begin{figure}
...
\begin{itemize}
	\item Cool things can be done!
	\item Many questions are still open $\rightarrow$ help is appreciated!
	\item Please contact us if you are interested in any of the mentioned problems
	\item They can be worked on in theses, project groups or assistant positions
\end{itemize}
}
