...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\frametitle{Possible problems with gradients}
...
\end{itemize}
\begin{figure}
	\includegraphics[height=0.4\textheight]{fig/lec09/Rastrigin.jpg}
...
\end{itemize}
\begin{figure}
	\includegraphics[height=0.5\textheight]{fig/lec09/random_search.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\frametitle{Other possible problems with gradients}
...
\end{itemize}
\begin{figure}
	\includegraphics[height=0.5\textheight]{fig/lec09/Non_differentiable_functions.pdf}
...
\onslide<1->{\begin{figure}
	\includegraphics[height=0.4\textheight]{fig/lec09/EA.png}
	\label{fig:EA}
