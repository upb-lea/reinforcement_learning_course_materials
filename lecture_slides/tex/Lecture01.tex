...
\begin{equation}
	v_k^* = \min_{\bm{u}_k} \sum_{i=0}^\infty r_{k+i+1} (\bm{x}_{k+i}, \bm{u}_{k+i})\,.
\end{equation}
\pause
...
\begin{equation}
	v_k^* = \min_{\bm{u}_k} \sum_{i=0}^{N_p} r_{k+i+1} (\bm{x}_{k+i}, \bm{u}_{k+i})\,.
\end{equation}
\pause
...
\begin{equation}
	\begin{split}
	v_k^* &= \min_{\bm{u}_k} \sum_{i=0}^{N_p} r_{k+i+1} (\bm{x}_{k+i}, \bm{u}_{k+i})\, ,\\
	\mathrm{s.t.} \quad \bm{x}_{k+i+1}&=\bm{f}(\bm{x}_{k+i},\bm{u}_{k+i}), \, \bm{x}_{k+i} \in \mathcal{X},\, \bm{u}_{k+i} \in \mathcal{U}\,.\\
\end{split}
\end{equation}
\begin{figure}
\centering
